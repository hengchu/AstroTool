...
- (void)viewDidLoad
{
  ...
  NSView *iconContainer = [NSView newAutoLayoutView];
...
//  [self.rightVC.view autoPinEdgesToSuperviewEdgesWithInsets:NSEdgeInsetsZero
//                                              excludingEdge:ALEdgeLeft];
  ...
  [self.rightVC.view autoPinEdge:ALEdgeTop toEdge:ALEdgeBottom ofView:iconContainer];
